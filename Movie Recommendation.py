...
Original file is located at
    https://colab.research.google.com/drive/1pGGfRedPXq9xEDiplciiXq1UZ9ReLNBy
"""
...
# Sample data: genres and their counts
genres = ['Action', 'Comedy', 'Drama', 'Horror', 'Romance']
counts = [20, 15, 30, 10, 25]
# Create a pie chart
fig, ax = plt.subplots()
ax.pie(counts, labels=genres, autopct='%1.1f%%', startangle=140, colors=plt.cm.Paired.colors)
